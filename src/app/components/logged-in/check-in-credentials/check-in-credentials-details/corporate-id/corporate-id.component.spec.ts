...
import {CorporateIdComponent} from './corporate-id.component';
import {By} from '@angular/platform-browser';

describe('CorporateIdComponent', () => {
  let corporateIdComponent: CorporateIdComponent;
  let fixture: ComponentFixture<CorporateIdComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [CorporateIdComponent]
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(CorporateIdComponent);
    corporateIdComponent = fixture.componentInstance;
    corporateIdComponent.corporateId = {
      firstName: 'Peter',
      familyName: 'Park',
      companyName: 'Dial Bugle',
      companySubject: 'Engineering',
      companyAddressStreet: 'Flatiron 32',
  ...
  it('should be created successfully', () => {
    expect(corporateIdComponent).toBeTruthy();
  });

  it('I should be able to see selected corporate-id first name', () => {
  ...
  it('I should be able to see selected corporate-id last name', () => {
  ...
  it('I should be able to see selected corporate-id company name', () => {
  ...
  it('I should be able to see selected corporate-id company subject', () => {
  ...
  it('I should be able to see selected corporate-id company address street', () => {
    const companyAddressStreet = fixture.debugElement.query(By.css('#corporate-id-company-address-street'));

    expect(companyAddressStreet.nativeElement.textContent).toBe('Flatiron 32');
  });

  it('I should be able to see selected corporate-id company address zip code', () => {
  ...
  it('I should be able to see selected corporate-id company address city', () => {
